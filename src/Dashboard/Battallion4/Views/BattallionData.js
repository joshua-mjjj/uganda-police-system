...
import { battallion_one_fetch_data, battallion_four_fetch_data } from '../../../actions/battallions_fetch.js';
...
const mapStateToProps = (state) => ({
  ...
  auth: state.auth,
  error: state.errors,
  data: state.battallions_fetch.battalion_four_data
});
